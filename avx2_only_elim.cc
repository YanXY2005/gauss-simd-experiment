...
void gauss_avx2_only_elim(vector<double>& A, vector<double>& b, int n) {
    for (int k = 0; k < n; k++) {
        // 行归一化：串行，不向量化
